...
const Modal = ({
    ...
    return (
        <div className={cx('w3-container')}>
            <div
                id="id01"
                className={cx('w3-modal')}
            >
                <div className={cx('w3-modal-content', 'w3-animate-top', 'w3-card-4')}>
                    <header
                        className={cx('w3-container', 'w3-teal')}
                        style={{ display: 'flex', color: '#000', padding: '1rem' }}
                    >
                        <span
                        ...
                        {isModalConfirm ? (
                            <h2 style={{ flex: 1, textAlign: 'center' }}>Bạn có muốn tiếp tục không?</h2>
                        ) : (
                        ...
                        {isModalVoucher ? (
                            ...
                            <>
                                ...
                                <input
                                    ...
                                    id="lname"
                                    name="lastname"
                                    placeholder={'Vui lòng nhập đúng định dạng: [{"size": 40,"amount": 1}, ...]'}
                                />
                    ...
                    <footer
                        className={cx('w3-container', 'w3-teal')}
                        style={{ padding: '1rem', borderTop: '1px solid #ccc', display: 'flex', justifyContent: 'end' }}
                    >
                        <button
                            type="button"
                            style={{
                        ...
                        <button
                            type="button"
                            style={{ padding: '1rem 2rem', backgroundColor: '#fff', cursor: 'pointer' }}
                            onClick={onCloseModal}
                        >
                            Hủy
                        </button>
